    ...
    <div class="panel-hero-muted">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h1 class="mt-2 text-3xl font-semibold text-slate-900">{{ $auctionTitle }}</h1>
            </div>
        </div>
        <div class="grid gap-4 sm:grid-cols-4">
            <div class="panel-metric"><p class="text-sm text-slate-500">Status</p><p class="mt-1 font-medium text-slate-900">{{ $auctionStatus }}</p></div>
            <div class="panel-metric"><p class="text-sm text-slate-500">Kategorija</p><p class="mt-1 font-medium text-slate-900">{{ $auctionCategory }}</p></div>
            <div class="panel-metric"><p class="text-sm text-slate-500">Seller</p><p class="mt-1 font-medium text-slate-900">{{ $auctionSeller }}</p></div>
            <div class="panel-metric"><p class="text-sm text-slate-500">Trenutna cijena</p><p class="mt-1 font-medium text-slate-900">{{ $auctionPrice }} BAM</p></div>
        </div>
    </div>
        ...
        <div class="space-y-8">
            ...
            <x-card class="panel-shell space-y-4">
                ...
                <div class="space-y-3">
                    ...
                    @empty
                        <div class="panel-subtle-card text-sm text-slate-600">Još nema evidentiranih moderatorskih odluka za ovu aukciju.</div>
                    @endforelse
                </div>
            </x-card>
        </div>
