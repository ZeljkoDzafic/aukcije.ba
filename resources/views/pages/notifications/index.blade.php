        ...
        <div class="panel-hero-muted">
            <div class="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
                <div>
                    ...
                    <p class="mt-2 max-w-2xl text-slate-600">Outbid, poruke, isporuke i sistemske promjene na jednom mjestu, sa jasnim prioritetom i brzim akcijama.</p>
                </div>
                <div class="flex flex-wrap gap-3">
                    ...
                    <form method="POST" action="{{ route('notifications.read-all') }}">
                        @csrf
                        <x-button>Označi sve kao pročitano</x-button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <x-card class="panel-shell space-y-5">
            ...
            <div class="grid gap-3 md:grid-cols-3">
                @foreach ($summaryCards as $card)
                    <a href="{{ $card['href'] }}" class="panel-shell-soft p-4 transition hover:-translate-y-0.5">
            ...
            <div class="space-y-3">
                @forelse ($notifications as $notification)
                    <div class="rounded-[1.75rem] border px-5 py-4 {{ $notification->read_at ? 'border-slate-200 bg-white' : 'border-trust-200 bg-trust-50/70' }}">
